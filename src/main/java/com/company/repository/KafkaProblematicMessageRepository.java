 ...
 */
@Repository
public interface KafkaProblematicMessageRepository extends CrudRepository<KafkaProblematicMessage, Long> {
  ...
  List<KafkaProblematicMessage> findTopByTimestampWithAttemptsLessThanFive();
}
